    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function (e) {
                ...
                var a = w.elem("div", {"class": "layui-laydate-header"}), i = [function () {
                        var e = w.elem("i", {"class": "result-icon icon-left"});
                        return e.innerHTML = "", e
                    }(), function () {
                        var e = w.elem("i", {"class": "result-icon icon-left2"});
                        return e.innerHTML = "", e
                    }(), function () {
                        var e = w.elem("div", {"class": "laydate-set-ym"}), t = w.elem("span"), n = w.elem("span");
                        return e.appendChild(t), e.appendChild(n), e
                    }(), function () {
                        var e = w.elem("i", {"class": "result-icon icon-right"});
                        return e.innerHTML = "", e
                    }(), function () {
                        var e = w.elem("i", {"class": "result-icon icon-right2"});
                        return e.innerHTML = "", e
