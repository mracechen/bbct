var prefix = "/manager/record/operationAccountRecord"
$(function () {
    load();
});
        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    //         if (value == 'RYHFlow') {
                    //             return "自由RYH";
                    //         } else if (value == 'RYHLock') {
                    //             return "锁仓RYH";
                    //         } else if (value == 'RYHFreed') {
                    //             return "释放RYH";
                    //         } else if (value == 'RYBFlow') {
                    //             return "自由RYB";
                    //         } else if (value == 'RYBLock') {
                    //             return "锁仓RYB";
                    //         } else if (value == 'RYBFreed') {
                    //             return "释放RYB";
                    //         }
                    //     },
                    //     sortable: true,
