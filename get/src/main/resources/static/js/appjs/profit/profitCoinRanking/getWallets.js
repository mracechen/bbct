...
function load() {
    var batchNum = window.parent.batchNum;
    var currency = window.parent.currency;
    $('#exampleTable')
        .bootstrapTable(
            {
                sortable: true,
                method: 'get', // 服务器数据的请求方式 get or post
                url: prefix + "/getWalletList", // 服务器数据的加载地址
                showRefresh: false,
                //	showToggle : true,
                //	showColumns : true,
                iconSize: 'outline',
                ...
                // //发送到服务器的数据编码类型
                pageSize: 10,pageList: [ 10, 25, 75, 100, ], // 如果设置了分页，每页数据条数
