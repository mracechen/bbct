...
public class UserUtils {
     ...
     * */
    public static List<UserListHelper> getList(List<SwUserBasicDO> recommenders, SwUserBasicDO swUserBasicDO, Integer generateNum){
        ...
        Integer count = 1;
        //排除系统用户，向上找18级
        while(curUserId != recommender && recommender != null && !recommender.equals(1) && count <= generateNum){
