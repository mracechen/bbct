...
import com.common.basicskills.domain.ColumnDO;
import com.common.basicskills.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtils.dateFormat(new Date(), DateUtils.DATE_TIME_PATTERN));
