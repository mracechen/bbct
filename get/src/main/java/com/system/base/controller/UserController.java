...
import com.common.basicskills.service.DictService;
...
import com.system.base.domain.RoleDO;
import com.system.base.domain.UserDO;
import com.system.base.service.DeptService;
import com.system.base.service.RoleService;
...
@RequestMapping("${backPathPrefix}/sys/user")
@Controller
...
//        user.setPassword(MD5Utils.encrypt(user.getUsername(), user.getPassword()));
        user.setPassword(MyMD5Utils.encodingAdmin(user.getUsername()+ user.getPassword()));
