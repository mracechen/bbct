...
public class SwReleaseRecordDO implements Serializable {
    ...
    public static SwReleaseRecordDO create(String principalUserId,Double amount,Integer causeType,Integer causeUserId){
        SwReleaseRecordDO swReleaseRecordDO = new SwReleaseRecordDO();
        swReleaseRecordDO.setTid(IDUtils.randomStr());
        swReleaseRecordDO.setPrincipalUserId(principalUserId);
