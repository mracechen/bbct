...
CREATE TABLE `t_sw_benchmarking`  (
  ...
  `num` decimal(20, 4) NULL DEFAULT NULL COMMENT '对标数量',
  `create_date` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `t_sw_release_record`  (
  `tid` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ID',
  `principal_user_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户持固币金id',
...
CREATE TABLE `t_sw_user_basic`  (
  ...
  PRIMARY KEY (`tid`) USING BTREE,
  UNIQUE INDEX `username`(`username`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 104399 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户基本表' ROW_FORMAT = Dynamic;
